...
##          |_3_|
##          |_0_|
##          |_1_|_2_|   orientation 0
        
        self.blockList = [Block(x, y, size, self.color), Block(x, y+size, size, self.color), Block(x+size, y+size, size, self.color), Block(x, y-size, size, self.color)]
